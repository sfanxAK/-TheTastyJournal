...
function displayCategories() {
  ...
  categories.forEach(category => {
    ...
    categoryElement.innerHTML = `
      ...
      <h3>${category.name}</h3>
      <a href="https://sfanxak.github.io/-TheTastyJournal/pages/categories.html=${encodeURIComponent(category.name.toLowerCase())}" class="category-link">View Recipes</a>
    `;
...
function displaySingleRecipe(recipeId) {
  ...
  singleRecipeContainer.innerHTML = `
    <div class="recipe-header">
      <a href="https://sfanxak.github.io/-TheTastyJournal/pages/recipes.html" class="back-link"><i class="fas fa-arrow-left"></i> Back to All Recipes</a>
      <h1>${recipe.title}</h1>
    ...
    <div class="recipe-tags">
      ${recipe.tags ? recipe.tags.map(tag => `<a href="https://sfanxak.github.io/-TheTastyJournal/pages/recipes.html?search=${tag}" class="recipe-tag">#${tag}</a>`).join('') : ''}
    </div>
    ...
    relatedRecipes.forEach(relatedRecipe => {
      ...
      recipeElement.innerHTML = `
        ...
        <div class="article-content">
          ...
          <a href="https://sfanxak.github.io/-TheTastyJournal/pages/recipes.html?id=${relatedRecipe.id}" class="read-more">Read More <i class="fas fa-arrow-right"></i></a>
        </div>
      `;
